...
from typing import AbstractSet, Any, ClassVar, Generic, Protocol, Self, TextIO, TypeVar, overload
...
class GlobMatchErrorBehavior:
    _engine_enum: bool
    ignore: GlobMatchErrorBehavior = ...
    warn: GlobMatchErrorBehavior = ...
    error: GlobMatchErrorBehavior = ...
    ...
    def name(self) -> str: ...
    @staticmethod
    def _members_() -> list[GlobMatchErrorBehavior]: ...
    def __eq__(self, other: GlobMatchErrorBehavior | Any) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...

class GlobExpansionConjunction:
    _engine_enum: bool
    any_match: GlobExpansionConjunction = ...
    all_match: GlobExpansionConjunction = ...
    def __init__(self, value: str) -> None: ...
    @property
    def value(self) -> str: ...
    @property
    def name(self) -> str: ...
    @staticmethod
    def _members_() -> list[GlobExpansionConjunction]: ...
    def __eq__(self, other: GlobExpansionConjunction | Any) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
