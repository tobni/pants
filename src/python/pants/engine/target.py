...
from pants.engine.internals.native_engine import MultipleSourcesField as MultipleSourcesField
...
from pants.engine.internals.native_engine import SingleSourceField as SingleSourceField
